...
const Settings = () => {
    ...
    {
      groups.push(
        <motion.li key={i} className={"calendar__setting-option " + style(`Grupa ${i}`)}
    ...
    return (
        <motion.div className="calendar__settings" initial={{opacity: 0, y: -100, scale: 0}} animate={{ opacity: 1, y: 0, scale: 1 }} exit={{ opacity: 0, y: -100, scale: 0 }} transition={{ type: "spring", stiffness: 600, damping: 50}}>
            <div className="calendar__setting">
              ...
              <div className="calendar__setting">
                ...
                <ul className="calendar__setting-list">
                  <div
                    className="calendar__setting-option calendar__setting-option--dark"
                  ></div>
                  <div
                    className="calendar__setting-option calendar__setting-option--light calendar__setting-option--selected"
                  ></div>
                </ul>
              </div>
        </motion.div>
